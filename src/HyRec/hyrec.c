...
int main(void)
{
   ...
   //remove("/Users/cangtao/cloud/GitHub/PBH/src/HyRec/outputs.txt");
   //OutputFile = fopen("/Users/cangtao/cloud/GitHub/PBH/src/HyRec/outputs.txt", "w");
   ...
   for (iz = 0; iz < nz; iz++)
   {
      ...
      if (Print_Results)
      {
         ...
         //fprintf(OutputFile, "%7.2lf %15.15lf %15.13lf\n", z, xe, Tm);
      }
   }
   // fclose(OutputFile)
