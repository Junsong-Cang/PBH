...
double rec_saha_xH1s(double xHeII, double nH0, double T0, double z, double fsR, double meR)
{
   ...
   if (s == 0.)
      ...
      return (1. + xHeII) / s - (xHeII * xHeII + 3. * xHeII + 2.) / s / s; /* Second-order value for xHII ~ 1 */
   else
      return 1. - 2. / (1. + xHeII / s + sqrt((1. + xHeII / s) * (1. + xHeII / s) + 4. / s));
}
                             ...
                             double fsR, double meR)
{
   ...
   g2pinc = 1.976e6 / (1. - exp(-6989. / Tr)) + 6.03e6 / (exp(19754. / Tr) - 1.) + 1.06e8 / (exp(21539. / Tr) - 1.) + 2.18e6 / (exp(28496. / Tr) - 1.) + 3.37e7 / (exp(29224. / Tr) - 1.) + 1.04e6 / (exp(32414. / Tr) - 1.) + 1.51e7 / (exp(32781. / Tr) - 1.);
