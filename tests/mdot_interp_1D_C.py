...
f0 = lambda x : Get_mdot(z = x, m = m, Use_Edd_Limit = 0, Use_EoR = Use_EoR, Use_C = 0)
f1 = lambda x : Get_mdot(z = x, m = m, Use_Edd_Limit = 0, Use_EoR = Use_EoR, Use_C = 1)
...
plt.plot(z, r0, 'k', linewidth=LineWidth, label = 'Python')
plt.plot(z, r1, '--r', linewidth=LineWidth, label = 'c')
plt.xscale('log')
plt.yscale('log')
